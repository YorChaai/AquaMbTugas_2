                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (event.getRawX() >= konfirmasi.getRight() - konfirmasi.getCompoundDrawables()[Right].getBounds().width()) {
                        ...
                        if (passwordVisible) {
                            ...
                            passwordVisible = false;
                            konfirmasi.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.vector_kunci1, 0, R.drawable.ic_visibility_off, 0);
                        } else {
                            konfirmasi.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                            passwordVisible = true;
                            konfirmasi.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.vector_kunci1, 0, R.drawable.ic_visibility_on, 0);
                        }
